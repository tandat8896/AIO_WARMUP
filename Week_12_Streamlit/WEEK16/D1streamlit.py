...
bai_tap = st.sidebar.selectbox(
    ...
    [
        ...
        "Bài 2 : So Sánh 2 hàm số trên cùng 1 biểu đồ",
        "Bài 3 : Vẽ đồ thị hàm số bậc 2 ",
        "Bài 4 : Tương tác với Slider để khảo sát đồ thị hàm số",
        "Bài 5 : Vẽ Heatmap cho hàm z = z = x² + y²"
    ]
)

if bai_tap ==  "Bài 1 : Vẽ đồ thị hàm số cơ bản ":
    st.header("Bài 1 : Vẽ đồ thị hàm số cơ bản" )
    st.write("Chọn 1 trong các hàm số sin,cos , exp,log, và vẽ trên biễu đồ trên đoạn[10,10]")
    ...
    if ham_so == "sin":
        ...
        x_log = np.linspace(0.01 , 10 , 10000)
        y = np.log(x_log)
        x = x_log
        ten_ham = "f(x) = log(x)"
...
elif bai_tap == "Bài 2 : So Sánh 2 hàm số trên cùng 1 biểu đồ":
...
elif bai_tap == "Bài 3 : Vẽ đồ thị hàm số bậc 2 ":
    ...
    if a != 0:
        ...
        if a > 0 :
            ...
            st.write("Đường parapol hướng xuống (có cực đại)")
    st.pyplot(fig)


elif bai_tap == "Bài 4 : Tương tác với Slider để khảo sát đồ thị hàm số":
    st.header("Bài 4 : Tương tác với Slider để khảo sát đồ thị hàm số")
...
elif bai_tap == "Bài 5 : Vẽ Heatmap cho hàm z = z = x² + y²":
    st.header("Bài 5 : Vẽ Heatmap cho hàm z = z = x² + y²")
    st.write("Dùng seaborn.heatmap vẽ biểu đồ nhiệt của hàm z = z = x² + y²") 
